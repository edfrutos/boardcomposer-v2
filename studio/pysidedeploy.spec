...
extra_args = --quiet --noinclude-qt-translations --macos-signed-app-name=com.efjdefrutos.boardcomposer.studio --macos-app-name="BoardComposer Studio" --macos-app-version=0.3.24 --include-package=google.genai --include-package=openai --include-package=certifi --include-package-data=certifi
