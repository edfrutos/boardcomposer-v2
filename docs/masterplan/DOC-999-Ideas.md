...
- **Biblioteca de materiales**: sin ninguna definición aquí hasta el 13/08/2026 — acotada con el usuario ese día (`DEC-0020`) como catálogo del taller (persiste entre proyectos, mismo patrón que el inventario de retales), con nombre/grosor/proveedor/precio, exportable/importable como CSV. **Promovida a `IDE-0041`** (`DEC-0020`, `docs/masterplan/DOC-004-Backlog.md`).
- **Comunidad**: sigue sin ninguna definición.
