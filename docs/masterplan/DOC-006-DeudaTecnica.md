...
| DT-0008 | DT-UX | Empaquetado y distribución de Studio pendiente: hoy se ejecuta desde código fuente, sin instalador ni binario distribuible. No bloquea el uso actual como herramienta interna. | 🔴 Abierto |
