...
| DT-0008 | DT-UX / DT-A | Endurecimiento para producción pendiente: sin autenticación ni rate limiting en la API, servidor de desarrollo de Flask (no WSGI de producción), sin empaquetado/distribución de Studio. Ninguno bloquea el uso actual como herramienta interna; si se expone a tráfico externo o datos de terceros, deben abordarse antes. | 🔴 Abierto |
