...
## Corpus Check
- Corpus is ~28,292 words - fits in a single context window. You may not need a graph.

## Summary
- 935 nodes · 1787 edges · 63 communities (53 shown, 10 thin omitted)
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 534 edges (avg confidence: 0.78)
- Token cost: 66,547 input · 0 output
...
- `IDE-0005 — Exportación PDF/SVG` --semantically_similar_to--> `SCR-007 — Exportación`  [INFERRED] [semantically similar]
  /Volumes/BACKUPS_PROYECTOS/__03.-Github_Repositories/boardcomposer/docs/masterplan/DOC-004-Backlog.md → docs/masterplan/ui/SCR-007-Exportación.md
...
- `test_find_candidates_returns_all_candidates()` --calls--> `MaxRects`  [INFERRED]
  tests/test_maxrects_candidates.py → src/boardcomposer/solver/maxrects/maxrects.py
- `test_place_candidate_updates_free_rectangles()` --calls--> `MaxRects`  [INFERRED]
  tests/test_maxrects_candidates.py → src/boardcomposer/solver/maxrects/maxrects.py
- `test_initial_free_rectangle()` --calls--> `MaxRects`  [INFERRED]
  tests/test_maxrects.py → src/boardcomposer/solver/maxrects/maxrects.py
...
- **Componentes principales de la pantalla de Exportación** — ui_scr_007_exportacion_formatos, ui_scr_007_exportacion_vista_previa, ui_scr_007_exportacion_plantillas [INFERRED 0.75]
...
### Community 1 - "CLI & Presenters"
Cohesion: 0.06
Nodes (42): ABC, build_demo_project(), main(), Presenter, JsonPresenter, solutions_to_json(), solution_to_text(), TextPresenter (+34 more)

### Community 2 - "Manifesto & Algorithm Comparison"
Cohesion: 0.05
Nodes (59): DOC-000 — Manifiesto del Proyecto, Algoritmos Genéticos, Beam Search (algoritmo de optimización), Comparación de algoritmos — todo puede compararse, CP-SAT, Explicabilidad — la explicación forma parte del resultado, MaxRects (algoritmo de optimización), Skyline (algoritmo de optimización) (+51 more)
...
### Community 5 - "Project Foundational Docs"
Cohesion: 0.06
...
### Community 7 - "Masterplan Product & Manifesto Docs"
Cohesion: 0.06
...
### Community 8 - "Geometry & Free Space"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (17): Board, largest_area_first(), longest_edge_first(), original_order(), test_largest_area_first(), test_longest_edge_first(), test_original_order(), test_candidate_pipeline_returns_ranked_solutions() (+9 more)
...
### Community 12 - "Project Domain & Free Space Generator"
Cohesion: 0.15
Nodes (15): Project, generate_free_space_solution(), free_space_generator(), maxrects_generator(), skyline_generator(), _candidate_orders(), _default_skyline_width(), _generate_for_order() (+7 more)
...
### Community 14 - "Placement & Collision"
Cohesion: 0.16
...
Cohesion: 0.20
Nodes (12): SolutionExplanation, AssemblySolution, horizontal_generator(), vertical_generator(), generate_horizontal_permutations(), generate_horizontal_solution(), generate_vertical_permutations(), generate_vertical_solution() (+4 more)
...
### Community 19 - "Constraints & Skyline Generator"
Cohesion: 0.18
Nodes (12): ProjectConstraints, generate_skyline_solution(), Generate Skyline-based layout solutions., Generate the best Skyline layout solution for the given project., test_constraints_accept_empty_values(), test_constraints_reject_invalid_max_length(), test_constraints_reject_invalid_max_width(), test_skyline_default_width_considers_rotation() (+4 more)

### Community 20 - "MaxRects Beam State & Scoring"
Cohesion: 0.17
...
### Community 23 - "Solver Search Strategies"
Cohesion: 0.24
Nodes (11): generate_beam_maxrects_solution(), generate_best_maxrects_solution(), search_best_solution(), _project(), test_beam_records_selected_heuristic(), test_beam_solution_records_strategy(), test_beam_width_one_matches_classic(), demo_project() (+3 more)
...
### Community 32 - "Sequential Solver"
Cohesion: 0.36
...
### Community 39 - "MaxRects Candidate Tests"
Cohesion: 0.50
...
### Community 40 - "CSV Data Requirements"
Cohesion: 0.67
...
## Knowledge Gaps
- **72 isolated node(s):** `boardcomposer`, `Ruff format check step`, `Ruff lint step`, `Run tests step (pytest)`, `Principle: the program proposes multiple solutions` (+67 more)
...
- **What is the exact relationship between `DOC-004 — Backlog del Producto` and `DOC-005 — Registro de Decisiones`?**
  _Edge tagged AMBIGUOUS (relation: references) - confidence is low._
- **Why does `LayoutService` connect `Studio App & Layout Service` to `Studio Main Window & Board Models`, `CLI & Presenters`?**
  _High betweenness centrality (0.206) - this node is a cross-community bridge._
- **Why does `Board` connect `Board Domain & Ordering` to `Sequential Solver`, `CLI & Presenters`, `CSV Loader & Project Check`, `MaxRects Engine`, `MaxRects Generator`, `Packing Runner & Commands`, `Geometry & Free Space`, `Project Domain & Free Space Generator`, `Assembly Solution & Layout Generator`, `Constraints & Skyline Generator`, `MaxRects Beam State & Scoring`, `Domain Package`, `Solver Search Strategies`, `Studio App & Layout Service`, `Generator Registry & Tests`, `Beam Search`, `MaxRects Runner`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `Project` connect `Project Domain & Free Space Generator` to `Sequential Solver`, `CLI & Presenters`, `CSV Loader & Project Check`, `MaxRects Engine`, `MaxRects Generator`, `Board Domain & Ordering`, `Assembly Solution & Layout Generator`, `Constraints & Skyline Generator`, `MaxRects Beam State & Scoring`, `Domain Package`, `Solver Search Strategies`, `Studio App & Layout Service`, `Generator Registry & Tests`, `MaxRects Runner`?**
